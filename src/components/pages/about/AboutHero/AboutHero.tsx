       ...
       <div className="w-2 h-2 rounded-full bg-blue-500" />
        ABOUT US
          ...
          <h1 className="mb-6 text-5xl font-medium leading-tight tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
            <span className="font-playfair italic">Great</span> brands are built
            <br />with <span className="font-playfair italic">intention</span>
          </h1>

          {/* Subheading */}
          <p className="mx-auto mb-10 max-w-[650px]  text-base text-gray-600 md:text-lg">
Inforisen partners with ambitious business leaders to build brands that drive alignment and unlock growth from the ins ide out.
          </p>
