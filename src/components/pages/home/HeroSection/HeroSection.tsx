...
export function HeroSection() {
  ...
  const rightBars = [
    ...
    { opacity: 0.5, color: "rgba(190,230,245,0.8)" },
    ...
    { opacity: 0.35, color: "rgba(200,240,245,0.1)" },
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mb-10 max-w-xl text-base text-gray-600 md:text-lg">
            We create digital experiences, products and services across the globe. Transform your business into genuine
            momentum.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button><Link href="/contact">Book a Call</Link></Button>
            <Button variant="secondary"><Link href="/portfolio">Our Portfolio</Link></Button>
          </div>
        </div>
      </div>
    </section>
