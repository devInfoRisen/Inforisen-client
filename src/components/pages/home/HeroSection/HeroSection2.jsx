...
export default function HeroSection2() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f8f8f8] to-[#f0f0f0]">
      ...
      <div className="flex h-full justify-center items-center  min-h-[800]">
        <div className="relative text-center z-20 h-full">
          <h1 className="mb-6 text-5xl font-medium leading-tight tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
            ...
            <br />& transform for{" "}
            <span className="font-playfair italic">growth.</span>
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="/">
              <PrimaryButton variant="outline">Our Portfolio</PrimaryButton>
            </Link>
            {/* <Button>
