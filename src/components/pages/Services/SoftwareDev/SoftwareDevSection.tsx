...
import image1 from "@/assets/soft-dev.png"  // ← replace with your actual software development mockup image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative aspect-square rounded-lg overflow-hidden">
              <Image
                src={image1}
                alt="Software development mockups including healthcare app, AI writing tool, and mobile interfaces"
                fill
