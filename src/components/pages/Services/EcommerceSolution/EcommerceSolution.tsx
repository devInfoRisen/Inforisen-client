...
import image1 from "@/assets/ecommerce.png"  // ← replace with your actual e-commerce mockup image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative aspect-square rounded-lg overflow-hidden">
              <Image
                src={image1}
                alt="E-commerce mobile app mockup with grocery shopping interface, delivery options and product categories"
                fill
