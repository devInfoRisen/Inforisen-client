...
import image1 from "@/assets/logobrand.png"  // ← replace with your actual SaaS products mockup image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative aspect-square rounded-lg overflow-hidden">
              <Image
                src={image1}
                alt="Floating colorful brand identity elements, logo mockups, and woman using app with Book Online button"
                fill
